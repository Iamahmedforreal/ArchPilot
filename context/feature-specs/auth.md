Clerk is already installed and connected. Wire it into the react app: provider, auth pages, redirects, route protection, and user menu.
...
## Check When Donebuilt-in `UserButton` to the editor navbar right section for profile settings and logout.
