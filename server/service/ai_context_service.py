...
def _application_instructions() -> str:
    ...
    return (
        ...
        "and icon registry keys, and use the iconKey paired with each supplied "
        "componentType. Use the default color pair unless another supported "
        "color and textColor pair is explicitly supplied. Every edge must set "
        "animated to false, type to 'smoothstep', stroke to "
        "'var(--text-faint)', strokeWidth to 1.5, and markerEnd to the supplied "
        "arrow style. Lay nodes out left to right with at least 64px "
